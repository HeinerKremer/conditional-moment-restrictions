...
class DeepIV(AbstractEstimationMethod):
    def __init__(self, model, moment_function, kernel_z_kwargs=None, val_loss_func=None, verbose=False):
        raise NotImplementedError('DeepIV implementation might be buggy!')
    ...
    def train(self, x_train, z_train, x_val, z_val, debugging=False):
        ...
        self._estimator = deep_iv(n_components=10, # Number of gaussians in the mixture density networks)
        ...
        self._estimator.fit(y, x, X=context, Z=z)
